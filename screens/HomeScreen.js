        ...
        <ScrollView>
          ...
          >
            ...
            <Pressable onPress={() => setModal(true)}>
              <Text>Deliver to Logesh - Bangalore 560021</Text>
            </Pressable>
      ...
      >
        <ModalContent>
          <View style={{ width: "100%", height: 400 }}>
            ...
            <View style={{ flexDirection: "column", gap: 7, marginBottom: 70 }}>
              <View
                style={{ flexDirection: "row", alignItems: "center", gap: 6 }}
              >
                <MaterialIcons name="location-on" size={24} color="#0066b2" />
              ...
              <View
                style={{ flexDirection: "row", alignItems: "center", gap: 6 }}
              >
                <Fontisto name="world-o" size={20} color="#0066b2" />
                <Text style={{ color: "#0066b2", fontWeight: "400" }}>
